...
boot::aircondit times between failures of air-conditioning equipment on aircraft. bootstrap,one-sample
boot::aircondit7 times between failures of air-conditioning equipment on aircraft. bootstrap,one-sample
...
boot::calcium calcium uptake from time. regression,bootstrap
...
boot::nodal stage of cancer (several ways) from age and acid (phosphatase). ordinal logistic regression
...
carData::MplsDemo Minneapolis demographic data, eg household income median from others. regression
...
MASS::muscle contraction of heart muscle from calcium chloride. regression
...
quantreg::engel annual household income and food expenditure. regression
...
UsingR::diamond diamond price and sizes in Singapore. regression, simple regression
