...
BSDA::Repair time to repair a wrecked car (hours). one-sample
...
fds::SAelectdemand Electricity dvcdExtra::Accidentemand in Adelaide. time series
...
MASS::crabs body measurements on 2 species of crabs. discriminant analysis,pca,cluster,manova
...
nlme::MathAchieve scores on math test by ses, sex but clustered by schools. sampling,dplyr
...
nlme::Oxide thickness of oxide %layer in semiconductors from source, lot, wafer within lot, site. anova
...
rrcov::diabetes diabetes measurements plus classification into 3 groups. discriminant,cluster,manova
...
vcdExtra::Accident traffic accident victimes in France classified by age, "result", mode, gender. log-linear,logistic regression
