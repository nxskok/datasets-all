...
This repo contains suggested statistical techniques for selected datasets found in R packages. The `notes` column contains occasional notes about where in the source it is used. (This is especially the case when the R help file is not informative.)
